        ...
        <div class="search">
            ...
            <div class="buttons">
                ...
                <div class="sort">
                    ...
                    <button class="button tertiary" id="sort" role="combobox" aria-haspopup="listbox" aria-expanded="false" aria-controls="sort-menu" data-selected="<?php echo !isset($_GET["sort"]) ? "latest" : $_GET["sort"] ?>">
