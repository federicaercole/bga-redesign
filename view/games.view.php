                ...
                <div class="scrollable">
                    <fieldset>
                        <legend><button type="button" aria-haspopup="true" aria-expanded="false">
                                ...
                                <?= printNumberofSelectedValues("players") ?>
                                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" focusable="false" aria-hidden="true">
                                    <path d="M12 15.375L6 9.37498L7.4 7.97498L12 12.575L16.6 7.97498L18 9.37498L12 15.375Z" />
                                </svg>
                            </button></legend>
                    ...
                    <fieldset>
                        <legend><button type="button" aria-haspopup="true" aria-expanded="false">
                                ...
                                Time
                                <?= printNumberofSelectedValues("time") ?>
                                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" focusable="false" aria-hidden="true">
                                    <path d="M12 15.375L6 9.37498L7.4 7.97498L12 12.575L16.6 7.97498L18 9.37498L12 15.375Z" />
                                </svg>
                            </button>
                    ...
                    <fieldset>
                        <legend><button type="button" aria-haspopup="true" aria-expanded="false">
                                ...
                                Complexity
                                <?= printNumberofSelectedValues("complexity") ?>
                                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" focusable="false" aria-hidden="true">
                                    <path d="M12 15.375L6 9.37498L7.4 7.97498L12 12.575L16.6 7.97498L18 9.37498L12 15.375Z" />
                                </svg>
                            </button></legend>
                    ...
                    <fieldset>
                        <legend><button type="button" aria-haspopup="true" aria-expanded="false">
                                ...
                                Mechanism
                                <?= printNumberofSelectedValues("mechanism") ?>
                                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" focusable="false" aria-hidden="true">
                                    <path d="M12 15.375L6 9.37498L7.4 7.97498L12 12.575L16.6 7.97498L18 9.37498L12 15.375Z" />
                                </svg>
                            </button>
                    ...
                    <fieldset>
                        <legend><button type="button" aria-haspopup="true" aria-expanded="false">
                                ...
                                Theme
                                <?= printNumberofSelectedValues("theme") ?>
                                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" focusable="false" aria-hidden="true">
                                    <path d="M12 15.375L6 9.37498L7.4 7.97498L12 12.575L16.6 7.97498L18 9.37498L12 15.375Z" />
                                </svg>
                            </button>
