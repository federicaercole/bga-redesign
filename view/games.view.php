    ...
    <div class="wrapper">
        <section class="search">
            <form method="get" role="search">
                ...
                <input type="text" id="search-input" name="s" aria-describedby="error-search" placeholder="Search for games" aria-haspopup="listbox" role="combobox" aria-expanded="false" aria-controls="games" aria-autocomplete="list" aria-describedby="assistive-hint" autocomplete="off">
            ...
            <div class="buttons">
                ...
                <div class="sort">
                    ...
                    <button class="button tertiary" id="sort" type="button" aria-haspopup="list" aria-expanded="false" aria-controls="sort-menu" data-selected="<?php echo !isset($_GET["sort"]) ? "latest" : $_GET["sort"] ?>">
                    ...
                    <ul class="dropdown" id="sort-menu" role="listbox" aria-labelledby="sort-label" tabindex="0">
