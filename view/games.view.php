...
<main>
    <div class="wrapper">
        <section class="search">
            ...
            <div class="buttons">
                <button class="button neutral" id="filter" type="button" aria-haspopup="true" aria-expanded="false"><span>Filter</span>
                ...
                <button class="button neutral" type="button" aria-haspopup="true" aria-expanded="false">Sort by <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" focusable="false" aria-hidden="true">
                        <path d="M12 15.375L6 9.37498L7.4 7.97498L12 12.575L16.6 7.97498L18 9.37498L12 15.375Z" />
                </button>
            </div>
    </div>
    </section>
    <div class="filters fixed-layout">
        <div class="wrapper fixed-layout">
            ...
            <ul tabindex="-1">
                <li><button type="button" aria-haspopup="true" aria-expanded="false">All Games <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" focusable="false" aria-hidden="true">
                            <path d="M12 15.375L6 9.37498L7.4 7.97498L12 12.575L16.6 7.97498L18 9.37498L12 15.375Z" />
                        </svg></button>
                    <div class="dropdown">
                        <ul>
                            <li><button class="selected"> <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24" focusable="false" aria-hidden="true">
                ...
                <li><button type="button" aria-haspopup="true" aria-expanded="false"><svg viewBox="0 0 10 11" xmlns="http://www.w3.org/2000/svg" focusable="false" aria-hidden="true" class="icon">
                ...
                <li><button type="button" aria-haspopup="true" aria-expanded="false">
                ...
                <li><button type="button" aria-haspopup="true" aria-expanded="false">
                        ...
                        Mechanics <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" focusable="false" aria-hidden="true">
                            <path d="M12 15.375L6 9.37498L7.4 7.97498L12 12.575L16.6 7.97498L18 9.37498L12 15.375Z" />
                        </svg>
                    </button></li>
                <li><button type="button" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="buttons">
                ...
                <button type="button" class="button neutral">Filter results</button>
            </div>
        </div>
    </div>
    <div class="wrapper">
