...
<main>
    <div class="wrapper">
        <section class="search">
            ...
            <div class="buttons">
                <button class="button neutral" type="button" aria-haspopup="true" aria-expanded="false">Filter
    ...
    <div class="filters fixed-layout show">
        <div class="wrapper fixed-layout">
            <button type="button" class="close">Close <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" focusable="false" aria-hidden="true">
                    <path d="m296-345-56-56 240-240 240 240-56 56-184-184-184 184Z" />
                </svg></button>
            <ul>
                <li><button type="button">All Games <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" focusable="false" aria-hidden="true">
                            <path d="M12 15.375L6 9.37498L7.4 7.97498L12 12.575L16.6 7.97498L18 9.37498L12 15.375Z" />
                        </svg></button>
                </li>
                <li><button type="button"><svg viewBox="0 0 10 11" xmlns="http://www.w3.org/2000/svg" focusable="false" aria-hidden="true" class="icon">
